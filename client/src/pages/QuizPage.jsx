    ...
    <div className="max-w-xl mx-auto px-4 py-8">
      ...
      {!showResult ? (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 border-t-4 border-green-400 animate-fadeIn">
          ...
          <button onClick={() => { setStep(0); setAnswers([]); setShowResult(false); }} className="px-4 py-2 rounded bg-violet-600 text-white font-bold hover:bg-green-600 transition-all">Recommencer</button>
        </div>
      )}
    </div>
  );
