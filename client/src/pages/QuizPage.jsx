...
const QuizPage = () => {
  ...
  // Récupération dynamique du quiz depuis le state de la navigation
  const quizData = location.state?.quiz;

  // Si quizData absent ou mal formé, on affiche un message d'erreur simple
  if (
    !quizData ||
    !quizData.titre ||
    ...
    return (
      <div className="max-w-xl mx-auto px-4 py-8 text-center">
        <p className="text-red-600 font-bold">
          Aucun quiz disponible ou données corrompues.
        </p>
        <button
          onClick={() => navigate(-1)}
  ...
  // États pour la navigation dans le quiz
